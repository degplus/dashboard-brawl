...
# REMOVIDO: Inicialização manual de st.session_state['authentication_status']
# A biblioteca streamlit-authenticator gerencia isso internamente.
...
if st.session_state["authentication_status"]:
    ...
    # Se o usuário não estiver autenticado, nada do dashboard é renderizado.
    # As mensagens de erro/aviso do login já foram exibidas acima.
    pass